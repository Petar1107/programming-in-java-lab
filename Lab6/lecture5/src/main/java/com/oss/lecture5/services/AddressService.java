...
public class AddressService{
    ...
    public List<Address> getAllAddresses(Integer pageNumber, Integer pageSize, String sortBy, String sortDirection) throws NotFoundException{
