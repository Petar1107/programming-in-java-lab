...
public class HistoryService {
    ...
    public List<History> getAllMeasurements(Integer pageNumber, Integer pageSize, String sortBy, String sortDirection) throws NotFoundException{
        ...
        var historyPage = historyRepository.findAll(pageable);
